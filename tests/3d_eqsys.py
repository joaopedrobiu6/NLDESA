...
def lorentz_force(w, t, a):
    ...
    dydt = jnp.asarray([vx, vy, vz, -(e/m)*Ex - (e/m)*(vy*Bz-vz*By), -(e/m)*Ey - (e/m)*(vz*Bx - vx*Bz), -(e/m)*Ez - (e/m)*(vx*By-vy*Bx)])
    return dydt
...
plot = eqsys.plot_phase(jnp.asarray([0, 1, 2]), title = 'Lorentz force', xlabel = 'x', ylabel = 'y', zlabel = 'z', color = 'r')
plt.show()
